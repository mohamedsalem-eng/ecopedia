import 'package:mechatronia_app/data/model/response/language_model.dart';

class AppConstants {
  static const String APP_NAME = 'mechatronia';
  static const String BASE_URL = 'https://ecopedia.mechatronia.com/';
  ...
  static const String SERVICES_URI = '/api/v1/products/services?limit=10&&offset=';
  ...
  static const String FEATURED_SERVICES_URI = '/api/v1/products/featured-services?limit=10&&offset=';
  ...
  static const String SUBMIT_SERVICE_URI = '/api/v1/service/submit';
  static const String SERVICE_TICKET_GET_URI = '/api/v1/service/get';
  static const String SERVICE_TICKET_CONV_URI = '/api/v1/service/conv/';
  static const String SERVICE_TICKET_REPLY_URI = '/api/v1/service/reply/';
  static const String SERVICE_TICKET_COUNT_URI = '/api/v1/service/count/';
  static const String SERVICE_TICKET_CHECK_URI = '/api/v1/service/check/';
