...
import 'package:mechatronia_app/view/screen/auth/widget/code_picker_widget.dart';
import 'package:mechatronia_app/view/screen/auth/widget/otp_verification_screen.dart';
    ...
    return Scaffold(
      ...
      body: Container(
        decoration: BoxDecoration(
          image: Provider.of<ThemeProvider>(context).darkTheme ? null : null,
        ),
        child: Column(
          children: [
            SafeArea(
              ...
              child: ListView(padding: EdgeInsets.all(Dimensions.PADDING_SIZE_SMALL), children: [
                ...
                Provider.of<SplashProvider>(context, listen: false).configModel.forgetPasswordVerification == "phone"
                    ? Text(getTranslated('enter_phone_number_for_password_reset', context),
                        style: titilliumRegular.copyWith(
                            color: Theme.of(context).hintColor, fontSize: Dimensions.FONT_SIZE_EXTRA_SMALL))
                ...
                Builder(
                  builder: (context) => !Provider.of<AuthProvider>(context).isLoading
                      ? CustomButton(
                          buttonText: Provider.of<SplashProvider>(context, listen: false)
                                      .configModel
                            ...
                            if (Provider.of<SplashProvider>(context, listen: false)
                              ...
                              if (_numberController.text.isEmpty) {
                                ...
                                Provider.of<AuthProvider>(context, listen: false)
                                    .forgetPassword(_countryDialCode + _numberController.text.trim())
                                    .then((value) {
                                  if (value.isSuccess) {
