...
import 'package:mechatronia_app/data/model/body/login_model.dart';
...
import 'package:mechatronia_app/view/screen/auth/forget_password_screen.dart';
import 'package:mechatronia_app/view/screen/auth/widget/mobile_verify_screen.dart';
import 'package:mechatronia_app/view/screen/auth/widget/social_login_widget.dart';
          ...
          Provider.of<AuthProvider>(context, listen: false)
            ...
            if (value.isSuccess) {
              ...
              Navigator.pushAndRemoveUntil(
                  context,
                  MaterialPageRoute(
                      builder: (_) => VerificationScreen(temporaryToken, '', _emailController.text.toString())),
                  (route) => false);
            }
          });
        } else if (Provider.of<SplashProvider>(context, listen: false).configModel.phoneVerification) {
          Navigator.pushAndRemoveUntil(
              context, MaterialPageRoute(builder: (_) => MobileVerificationScreen(temporaryToken)), (route) => false);
        }
      } else {
              ...
              children: [
                ...
                InkWell(
                  ...
                  child: Text(getTranslated('FORGET_PASSWORD', context),
                      style: titilliumRegular.copyWith(color: ColorResources.getLightSkyBlue(context))),
                ),
              ],
            ),
          ),
          ...
          GestureDetector(
            onTap: () {
              if (!Provider.of<AuthProvider>(context, listen: false).isLoading) {
                ...
                Navigator.pushAndRemoveUntil(
                    context, MaterialPageRoute(builder: (_) => DashBoardScreen()), (route) => false);
              }
            },
            child: Container(
