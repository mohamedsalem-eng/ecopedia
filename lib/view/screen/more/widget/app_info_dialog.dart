          ...
          children: [
                ...
                InkWell(
                  ...
                  child: Container(
                      ...
                      decoration: BoxDecoration(
                        ...
                        boxShadow: [
                          BoxShadow(
                              color: Colors.grey.withOpacity(0.2), spreadRadius: 1, blurRadius: 7, offset: Offset(0, 1))
                        ],
                      ),
            ...
            Row(
              ...
              children: [
                ...
                Text(Provider.of<SplashProvider>(context, listen: false).packageInfo.buildNumber,
                    style: titilliumSemiBold.copyWith(fontSize: Dimensions.FONT_SIZE_LARGE)),
              ],
            ),
            Divider(thickness: .1, color: Theme.of(context).primaryColor),
