...
import 'package:mechatronia_app/view/screen/profile/widget/add_address_bottom_sheet.dart';
                          ...
                          itemBuilder: (context, index) {
                            return InkWell(
                              ...
                              child: Container(
                                ...
                                child: ListTile(
                                  leading: Image.asset(
                                    profile.addressList[index].addressType == 'Home'
                                        ? Images.home_image
                                        : profile.addressList[index].addressType == 'Ofice'
                                            ? Images.bag
                                            : Images.more_image,
