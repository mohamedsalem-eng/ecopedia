...
import 'package:mechatronia_app/view/screen/wishlist/widget/wishlist_widget.dart';
            ...
            trailing: Column(
                ...
                children: [
                  Container(
                      height: 15,
                      width: 15,
                      decoration: BoxDecoration(shape: BoxShape.circle, color: ColorResources.WHITE)),
                  SizedBox(height: 10),
                  Container(height: 10, width: 50, color: ColorResources.WHITE),
                ]),
          ),
