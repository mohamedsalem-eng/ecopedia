                              ...
                              child: Stack(
                                ...
                                children: <Widget>[
                                  ...
                                  CustomPaint(
                                    size: Size(100, 40),
                                    foregroundPainter:
                                        new MyPainter(completeColor: ColorResources.getColombiaBlue(context), width: 2),
                                  ),
                                ],
                              ),
                            )
                    ...
                    onTap: () {
                      if (Provider.of<ProductDetailsProvider>(context, listen: false).rating == 0) {
                        ...
                        Provider.of<ProductDetailsProvider>(context, listen: false)
                            .submitReview(
                                reviewBody, _files, Provider.of<AuthProvider>(context, listen: false).getUserToken())
                            .then((value) {
                          if (value.isSuccess) {
