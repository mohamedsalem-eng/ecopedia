...
import 'package:mechatronia_app/view/screen/product/product_image_screen.dart';
import 'package:mechatronia_app/view/screen/product/widget/favourite_button.dart';
      ...
      children: [
        InkWell(
          onTap: () => Navigator.of(context).push(MaterialPageRoute(
              builder: (_) => ProductImageScreen(imageList: productModel.images, title: productModel.name))),
          child: Container(
            ...
            child: Stack(children: [
              ...
              Positioned(
                ...
                child: FavouriteButton(
                  ...
                  favColor: ColorResources.getRed(context),
                ...
                child: Container(
                  ...
                  decoration: BoxDecoration(
                    ...
                    border: Provider.of<ProductDetailsProvider>(context).imageSliderIndex == index
                        ? Border.all(color: ColorResources.getPrimary(context), width: 2)
                        : null,
                  ),
                  child: Padding(
