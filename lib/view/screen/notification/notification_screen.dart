...
import 'package:mechatronia_app/view/screen/notification/widget/notification_dialog.dart';
                              ...
                              return InkWell(
                                ...
                                child: Container(
                                  ...
                                  child: ListTile(
                                    ...
                                    title: Text(notification.notificationList[index].title,
                                        style: titilliumRegular.copyWith(
                                          fontSize: Dimensions.FONT_SIZE_SMALL,
                                        )),
                                    subtitle: Text(
                                      DateConverter.localDateToIsoStringAMPM(
                                          DateTime.parse(notification.notificationList[index].createdAt)),
                                      style: titilliumRegular.copyWith(
