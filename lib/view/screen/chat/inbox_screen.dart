                ...
                child: Provider.of<ChatProvider>(context).isSearching
                    ? TextField(
                        ...
                        style: titilliumSemiBold.copyWith(
                            color: ColorResources.WHITE, fontSize: Dimensions.FONT_SIZE_LARGE),
                                        ...
                                        ListTile(
                                          ...
                                          title: Text(
                                            chat.uniqueShopList[index].sellerInfo != null
                                                ? chat.uniqueShopList[index].sellerInfo.fName ??
                                          ...
                                          subtitle: Container(
                                              child: Text(chat.uniqueShopList[index].message,
                                                  maxLines: 4,
                                                  overflow: TextOverflow.ellipsis,
                                          ...
                                          trailing: Column(mainAxisAlignment: MainAxisAlignment.center, children: [
                                            Text(
                                                DateConverter.localDateToIsoStringAMPM(
                                                    DateTime.parse(chat.uniqueShopList[index].createdAt)),
                                                style: titilliumRegular.copyWith(
                                                    fontSize: Dimensions.FONT_SIZE_EXTRA_SMALL)),
                                          ]),
                                          onTap: () => Navigator.push(context, MaterialPageRoute(builder: (_) {
                                            ...
                                            return ChatScreen(
                                                seller: null,
                                                shopId: chat.uniqueShopList[index].shopId,
                                                name: chat.uniqueShopList[index].sellerInfo.fName +
                                                    ' ' +
                                                    chat.uniqueShopList[index].sellerInfo.lName,
