...
import 'package:mechatronia_app/data/model/body/MessageBody.dart';
import 'package:mechatronia_app/data/model/response/top_seller_model.dart';
import 'package:mechatronia_app/data/model/response/chat_model.dart';
...
import 'package:mechatronia_app/view/screen/chat/widget/message_bubble.dart';
                          ...
                          return MessageBubble(
                              ...
                              onProfileTap: () {
                                Navigator.push(context,
                                    MaterialPageRoute(builder: (_) => AllTopSellerScreen(topSeller: topSeller)));
                              });
                        },
                      )
                    : SizedBox.shrink()
                      ...
                      onTap: () {
                        if (Provider.of<ChatProvider>(context, listen: false).isSendButtonActive) {
                          MessageBody messageBody =
                              MessageBody(shopId: topSeller.id.toString(), message: _controller.text);
