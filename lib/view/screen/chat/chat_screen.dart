...
class ChatScreen extends StatelessWidget {
  ...
  final String name;
  final String image;
  ChatScreen({@required this.seller, this.topSeller, this.shopId, this.sellerId, this.name, this.image});
                        ...
                        onTap: () {
                          if (Provider.of<ChatProvider>(context, listen: false).isSendButtonActive) {
                            MessageBody messageBody = MessageBody(
                                sellerId: sellerId.toString(), shopId: shopId.toString(), message: _controller.text);
