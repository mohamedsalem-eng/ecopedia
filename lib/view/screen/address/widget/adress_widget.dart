                          ...
                          child: Column(
                            ...
                            children: [
                              ...
                              Text(
                                ...
                                style: robotoRegular.copyWith(
                                    color: ColorResources.getTextTitle(context), fontSize: Dimensions.FONT_SIZE_LARGE),
                              ),
                            ],
                          ),
                        )
                    ...
                    onSelected: (String result) {
                      if (result == 'delete') {
                        ...
                        Provider.of<LocationProvider>(context, listen: false)
                            .deleteUserAddressByID(addressModel.id, index, (bool isSuccessful, String message) {
