...
import 'package:mechatronia_app/view/screen/tracking/painter/line_dashed_painter.dart';
      ...
      body: Column(
        children: [
                            ...
                            children: [
                              Container(
                                ...
                                decoration: BoxDecoration(
                                    color: Theme.of(context).highlightColor, borderRadius: BorderRadius.circular(5)),
                                child: Column(
                                  ...
                                  children: [
                                    ...
                                    CustomStepper(
                                        title: status == 'pending'
                                            ...
                                            : getTranslated('ORDER_PLACED_PREPARING', context),
                                    ...
                                    CustomStepper(
                                        title: status == 'pending'
                                            ...
                                            : status == 'confirmed'
                                                ? getTranslated('processing', context)
                                                : getTranslated('ORDER_PICKED_SENDING', context),
                                    ...
                                    CustomStepper(
                                        title: status == 'pending'
                                            ...
                                            : status == 'confirmed'
                                                ...
                                                : status == 'processing'
                                                    ? getTranslated('processing', context)
                                                    : getTranslated('RECEIVED_LOCAL_WAREHOUSE', context),
          ...
          Container(
            ...
            decoration:
                BoxDecoration(color: ColorResources.getImageBg(context), borderRadius: BorderRadius.circular(6)),
            child: TextButton(
              ...
              child: Container(
                ...
                child: Text(
                  ...
                  style: titilliumSemiBold.copyWith(
                      fontSize: Dimensions.FONT_SIZE_LARGE, color: ColorResources.getPrimary(context)),
                ),
              ),
            ),
          ),
      ...
      child: Column(
        ...
        children: [
          ...
          isLastItem
              ...
              : Padding(
                  padding:
                      EdgeInsets.only(top: Dimensions.PADDING_SIZE_EXTRA_SMALL, left: Dimensions.PADDING_SIZE_LARGE),
