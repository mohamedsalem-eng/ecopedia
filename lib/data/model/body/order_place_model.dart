...
class OrderPlaceModel {
  ...
  OrderPlaceModel(CustomerInfo customerInfo, List<CartModel> cart, String paymentMethod, double discount) {
  ...
  OrderPlaceModel.fromJson(Map<String, dynamic> json) {
    _customerInfo = json['customer_info'] != null ? new CustomerInfo.fromJson(json['customer_info']) : null;
    if (json['cart'] != null) {
      _cart = [];
      json['cart'].forEach((v) {
...
class Cart {
  ...
  Cart(String id, double tax, int quantity, double price, double discount, String discountType, int shippingMethodId,
      String variant, List<Variation> variation, double shippingCost) {
    this._id = id;
    this._tax = tax;
