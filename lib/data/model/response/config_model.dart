...
class ConfigModel {
  ...
  List<String> get fileExt => _fileExt;
  ...
  ConfigModel.fromJson(Map<String, dynamic> json) {
    ...
    _digitalPayment = json['digital_payment'] == 1 || json['digital_payment'] == '1' ? true : false;
    _cod = json['cash_on_delivery'] == 1 || json['cash_on_delivery'] == '1' ? true : false;
    ...
    if (json['area_list'] != null) {
      ...
      json['area_list'].forEach((v) {
        _areaList.add(new AreaModel.fromJson(v));
      });
    }
    ...
    _fileExt = json['file_ext'].cast<String>();
    if (json['colors'] != null) {
      _colors = [];
